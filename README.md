...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 508,339 | 🐛 106 | 📅 2026-09-02
...
* [GitHub](https://github.com/typst/typst) ⭐ 56,151 | 🐛 1,290 | 🌐 Rust | 📅 2026-09-18 - The official Typst repository.
...
* [best-of-typst](https://github.com/YDX-2147483647/best-of-typst) ⭐ 124 | 🐛 4 | 🌐 Typst | 📅 2026-09-19 - A ranked list of awesome projects related to Typst..
...
* [typstyle](https://github.com/typstyle-rs/typstyle) ⭐ 888 | 🐛 37 | 🌐 Rust | 📅 2026-09-16 - Opinionated typst code formatter focusing on aesthetic, convergence and correctness.
* [Tylax](https://github.com/scipenai/tylax) ⭐ 498 | 🐛 17 | 🌐 Rust | 📅 2026-09-14 - A bidirectional LaTeX-Typst converter based on AST parsing, with support for TikZ graphics.
* [utpm](https://github.com/typst-community/utpm) ⭐ 144 | 🐛 6 | 🌐 Rust | 📅 2026-05-23 - *Package manager* for **[local](https://github.com/typst/packages#local-packages) ⭐ 1,027 | 🐛 59 | 🌐 Rust | 📅 2026-09-18** and **[remote](https://github.com/typst/packages) ⭐ 1,027 | 🐛 59 | 🌐 Rust | 📅 2026-09-18** Typst packages.
...
* [BeauTyXT](https://github.com/soupslurpr/BeauTyXT) ⭐ 229 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-21 - A private, secure, minimalistic Text, Markdown, and Typst editor for Android.
...
* [Katvan](https://github.com/IgKh/katvan) ⭐ 185 | 🐛 12 | 🌐 C++ | 📅 2026-09-20 - A bare-bones editor for Typst files, with a bias for Right-to-Left editing.
...
* [typos](https://github.com/dailydaniel/typos) ⭐ 59 | 🐛 2 | 🌐 Rust | 📅 2026-03-27 - A Typst-native note-taking system powered by Rust and Tauri with typed metadata, cross-references, backlinks, and knowledge graph visualization.
* [Typesetter](https://typesetter.trowell.net/) - A minimalist, local-first Typst editor for Linux.

### Editor Integrations

* [Tinymist](https://github.com/Myriad-Dreamin/tinymist) ⭐ 3,544 | 🐛 212 | 🌐 Rust | 📅 2026-09-20 - A language server for Typst with integrations for Emacs, Helix, Neovim, Sublime Text, VSCode/VsCodium, and Zed.
...
* [brilliant-CV](https://github.com/yunanwg/brilliant-CV) ⭐ 841 | 🐛 4 | 🌐 Typst | 📅 2026-09-21 - Another CV template for your job application, yet powered by Typst and more.
...
* [CeTZ](https://github.com/cetz-package/cetz) ⭐ 1,849 | 🐛 74 | 🌐 Typst | 📅 2026-09-17 - A library for drawing with Typst, with an API inspired by TikZ and Processing. It comes with modules for drawing plots, graphs, and charts.
...
* [tyipa](https://github.com/typst/packages/tree/main/packages/preview/tyipa/0.1.0) ⭐ 1,027 | 🐛 59 | 🌐 Rust | 📅 2026-09-18 - Write phonetic transcriptions using the IPA, in a *typsty* style.
...
* [lilaq](https://github.com/lilaq-project/lilaq) ⭐ 848 | 🐛 26 | 🌐 Typst | 📅 2026-08-14 - Advanced data visualization with Typst, easy to use, customizable, sane defaults.
...
* [touying](https://github.com/touying-typ/touying) ⭐ 2,342 | 🐛 27 | 🌐 Typst | 📅 2026-09-17 - A powerful package for creating presentation slides in Typst.
